...
### Необходимо собрать клиент:

1. В `package/client` и выполнить команду `yarn build:ssr`
2. В `package/client` и выполнить команду `yarn build`

### Для локальной разработки необходимо связать клиент с сервером:

1. В `package/client` и выполнить команду `yarn link`
2. В `package/server` и выполнить команду `yarn link 'client'`

### Сборка и запуск сервера:

В `package/server` и выполнить команду `yarn build && node dist/index.js`

Для продакшена необходимо опубликовать клиент как пакет, и потом портировать слиент в сервер
